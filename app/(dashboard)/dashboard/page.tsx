...
export default function DashboardPage() {
  ...
  const getWelcomeMessage = (role: string) => {
    switch (role) {
      ...
      case "staff":
        return "您可以管理景点、动植物和公告信息，但无法管理用户和系统设置。"
      case "visitor":
    ...
    <div className="space-y-6">
      ...
      {!isLoading && currentUser && (
        <Alert>
          ...
          <AlertDescription>
            您当前的角色是：<span className="font-bold">{roleNameMap[currentUser.role] || currentUser.role}</span>。
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="border-b pb-2">
                ...
                <p className="text-sm text-muted-foreground">2023年4月15日 - 2023年4月20日</p>
              </div>
              <div className="border-b pb-2">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between border-b pb-2">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">较上月减少0.3秒</p>
                </div>
