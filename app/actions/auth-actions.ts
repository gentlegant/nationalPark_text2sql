...
export async function login(formData: FormData): Promise<LoginResult> {
  ...
  try {
    ...
    cookieStore.set("userId", user.id.toString(), { expires, httpOnly: true });
    cookieStore.set("username", user.username, { expires, httpOnly: true });
    cookieStore.set("role", user.role_name || "visitor", {
      expires,
      httpOnly: true,
    });
